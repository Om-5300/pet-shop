        ...
        <div className="aboutusimg">
          {[1, 2, 3, 4, 5].map((num, index) => (
            <img 
              ...
              className={`aboutimg aboutimg${num} ${index > 2 ? "hide-mobile" : ""}`} 
              alt={`img${num}`} 
            />
          ))}
        </div>
