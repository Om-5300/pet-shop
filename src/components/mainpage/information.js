  ...
  return (
    <div className="information">
      <div className="leftinformation">
        ...
        <p>We provide high-quality pet products and services to ensure your furry, feathered, and finned friends live happy and healthy lives. From nutritious food to cozy accessories, we've got everything your pet needs!</p>
      </div>
